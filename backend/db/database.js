  ...
  if (!sqliteDbInstance) {
    ...
    sqliteDbInstance = new s3.Database(sqliteDbPath, (err) => {
      if (err) {
        ...
        console.log('[SQLITE] Connected to SQLite database at:', sqliteDbPath);
      }
    });
  }
...
const initSqlite = async () => {
  ...
  console.log('[SQLITE] SQLite Database Initialized Successfully with V87 Schema & Data');
};
